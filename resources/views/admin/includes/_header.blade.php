    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="#" class="logo">
                    <span class="logo-sm">
                        <img src="{{Vite::asset('resources/images/logo.png') }}" alt="" height="12">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ Vite::asset('resources/images/logo.png') }}" alt="Masscom" height="35">
                    </span>
                </a>
            </div>
...
{{--                    <a class="dropdown-item" href="#"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span>Profile</span></a>--}}
                    ...
                    <a class="dropdown-item text-danger" href="{{route('admin.logout')}}"
                       onclick="return confirm('you want to logout?');"><i
            ...
            <div class="modal-body">
                <form method="POST" id="change-password">
                    ...
                    <div class="mt-3 d-grid">
                        <button class="btn btn-primary waves-effect waves-light UpdatePassword" type="submit">Update
                            Password
                        </button>
                    </div>
                </form>
