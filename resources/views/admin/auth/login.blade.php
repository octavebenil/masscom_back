                            ...
                            <div class="p-2">
                                <form class="form-horizontal" id="loginForm" action="{{ route('admin.login.post') }}"
                                    ...
                                    <div class="mt-4 text-center">
                                        <a href="{{ route('admin.forgot-password.get') }}" class="text-muted"><i class="fa-solid fa-lock me-1"></i> Forgot your password?</a>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            ...
                            <p>©
                                ...
                                Crafted with <i class="mdi mdi-heart text-danger"></i> by Masscom
                            </p>
                        </div>
                    </div>
